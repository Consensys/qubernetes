...
then
  ...
  echo docker run -v $(pwd):/qubernetes -ti quorumengineering/qubernetes ./quorum-init quickest-start.yaml
  docker run -v $(pwd):/qubernetes -ti quorumengineering/qubernetes ./quorum-init quickest-start.yaml
